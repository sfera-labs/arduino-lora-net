...
void IonoRemoteSlave::_update_state(byte *data, int data_len) {
  Serial.println("IonoRemoteSlave::_update_state");
...
int IonoRemoteSlave::_get_cmd_data_len() {
  return 4;
}

void IonoRemoteSlave::write(int pin, float value) {
  int idx;
  switch (pin) {
    case DO1:
